...
public class XLSSelectedFragment extends BaseFragment {
    ...
    private void initData() {
        showRecycleViewModel = new ViewModelProvider(XLSSelectedFragment.this,
    ...
    private void updateAdapter(List<Integer> message) {
        showRecycleViewModel.searchDocumentInfoList(DocumentRelatedConstants.TYPE_XLS, message);
        showRecycleViewModel.getDocumentInfoListLiveData().observe(getViewLifecycleOwner(), new Observer<List<DocumentInfo>>() {
            ...
            public void onChanged(List<DocumentInfo> documentInfoList) {
                RecyclerViewHelper.updateAdapter(requireActivity(), rvXLSSelected, message.get(0), documentInfoList, XLSSelectedFragment.this, nsvXlsSelectedNoResult,2);
            }
        });
    }
