...
public class TXTSelectedFragment extends BaseFragment {
    ...
    private void initData() {
        showRecycleViewModel = new ViewModelProvider(TXTSelectedFragment.this,
    ...
    private void updateAdapter(List<Integer> message) {
        showRecycleViewModel.searchDocumentInfoList(DocumentRelatedConstants.TYPE_TXT, message);
        showRecycleViewModel.getDocumentInfoListLiveData().observe(getViewLifecycleOwner(), new Observer<List<DocumentInfo>>() {
            ...
            public void onChanged(List<DocumentInfo> documentInfoList) {
                RecyclerViewHelper.updateAdapter(requireActivity(), rvTXTSelected, message.get(0), documentInfoList, TXTSelectedFragment.this,nsvTxtSelectedNoResult,2);
            }
        });
    }
